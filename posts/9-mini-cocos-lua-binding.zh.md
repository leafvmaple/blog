# 手写 Lua metatable：跳过 sol2 换来的可控性
...
主流做法是直接用 [sol2](https://github.com/ThePhD/sol2) —— 三行模板就能把一个 C++ class 绑给 Lua。我没用。这一篇说清楚我**为什么选了手写 metatable**，写起来什么样，以及代价。重点是后半部分关于跨边界生命周期的内容 —— 这是任何 C++/Lua 绑定方案都必须解决但鲜少有人写明白的部分。
...
*本文是 [mini-cocos 设计复盘](https://github.com/leafvmaple/blog/issues/2) 系列的衍生深读。相关阅读：[内存模型](https://github.com/leafvmaple/blog/issues/3)、[EventDispatcher](https://github.com/leafvmaple/blog/issues/5)。*
