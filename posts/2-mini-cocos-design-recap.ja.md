...
- [0. なぜ「古いやつ」を再実装するのか](#sec-0)
- [1. まずは三角形を描画させる (aee61f3)](#sec-1)
- [2. メモリ管理 + スケジューラ (e8b36a2)](#sec-2)
  - [2.1 Ref + AutoreleasePool：なぜ shared_ptr を直接使わないのか](#sec-2-1)
  - [2.2 Scheduler：ダーティフラグ + ペンディングキュー](#sec-2-2)
- [3. イベントシステムの2回の改修 (fb4300f → b3cc36c → 4b1fc47 系列)](#sec-3)
  - [3.1 第1版：生のコールバック](#sec-3-1)
  - [3.2 第2版：型ごとにサブクラス化、callback をフィールド化](#sec-3-2)
  - [3.3 第3版：cocos2dx に寄せた二重リンクの EventDispatcher (4b1fc47 / db6b6dd / 90acab7)](#sec-3-3)
  - [3.4 親子ノードの遮蔽 (bacb0f9)](#sec-3-4)
- [4. レンダリングキュー：64-bit sortKey で struct 比較を置き換える (db7892d)](#sec-4)
- [5. フォントとリソース：動的 glyph cache vs 事前焼き込みアトラス (f91253a / 3a5bedd)](#sec-5)
- [6. Action：「時間」を組み合わせ可能なオブジェクトにする (05c476e / 495a6e9)](#sec-6)
- [7. Lua バインディング：手書き糊 vs sol2 (eb546b2 / 82839bc)](#sec-7)
- [8. TextureCache + Animation：参照カウントを使うべきでない場面 (983b63e)](#sec-8)
- [9. プラットフォーム非依存の FileUtils：検索パスと解像度の優先度 (1154c98)](#sec-9)
- [10. OpenGL を抽出し、デフォルトを Vulkan に切り替える (eb0053e / bd9cdff / 1831a70)](#sec-10)
- [11. 「小さな」コミットに宿る工学的美意識](#sec-11)
  - [11.1 c724ecb —— 冗長なコンストラクタを削除](#sec-11-1)
  - [11.2 bf4b46a —— std::erase_if で erase-remove を置き換え](#sec-11-2)
  - [11.3 6c1d2b3 —— キーボードとマウスを2ファイルに分割](#sec-11-3)
- [12. 振り返り：3週間で1500行、結局何を学んだのか](#sec-12)
