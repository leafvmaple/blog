...
export const T = {
  zh: {
    ...
    archive_link: '归档 / Archive →',
    archive_title: '归档',
    archive_description: '按年-月排列的全部文章',
    archive_count_prefix: '共 ',
    archive_count_suffix: ' 篇',
    label_title_prefix: '标签：',
    label_count_prefix: '共 ',
    label_count_suffix: ' 篇',
    label_not_found: '该标签下暂无文章',
    series_post_count_suffix: ' 篇',
    series_repo_link: '仓库 ↗',
    series_back_to_index: '← 系列首页',
  ...
  ja: {
    ...
    archive_link: 'アーカイブ / Archive →',
    archive_title: 'アーカイブ',
    archive_description: '年-月ごとの全記事一覧',
    archive_count_prefix: '全 ',
    archive_count_suffix: ' 件',
    label_title_prefix: 'タグ：',
    label_count_prefix: '全 ',
    label_count_suffix: ' 件',
    label_not_found: 'このタグの記事はまだありません',
    series_post_count_suffix: ' 件',
    series_repo_link: 'リポジトリ ↗',
    series_back_to_index: '← シリーズトップ',
    series_not_found: 'シリーズが見つかりません',
    series_prev: '前の記事',
    series_next: '次の記事',
    series_in: 'シリーズ：',
    back_to_list: '← 一覧に戻る',
